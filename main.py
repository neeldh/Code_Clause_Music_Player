...
top_lab=PhotoImage(file="Music-Player\\Code_Clause_Music_Player\\top.png")
Label(root,image=top_lab,bg="#0f1a2b").place(x=0,y=0)

#logo
Logo=PhotoImage(file="Music-Player\\Code_Clause_Music_Player\\logo.png")
Label(root,image=Logo,bg="#0f1a2b").place(x=65,y=115)

#button
play_button=PhotoImage(file="Music-Player\\Code_Clause_Music_Player\\play.png")
Button(root,image=play_button,bg="#0f1a2b",bd=0,command=play_song).place(x=100,y=400)

stop_button=PhotoImage(file="Music-Player\\Code_Clause_Music_Player\\stop.png")
Button(root,image=stop_button,bg="#0f1a2b",bd=0,command=mixer.music.stop).place(x=30,y=500)

resume_button=PhotoImage(file="Music-Player\\Code_Clause_Music_Player\\resume.png")
Button(root,image=resume_button,bg="#0f1a2b",bd=0,command=mixer.music.unpause).place(x=115,y=500)

pause_button=PhotoImage(file="Music-Player\\Code_Clause_Music_Player\\pause.png")
...
#music
Menu=PhotoImage(file="Music-Player\Code_Clause_Music_Player\menu.png")
